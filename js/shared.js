...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const SITE_SEARCH_INDEX = [
      ...
      { section: 'Page', title: 'SOX Scoping Worksheet', preview: 'Risk-based top-down scoping — score systems for in-scope determination', href: 'scoping.html' },
      { section: 'Page', title: 'Sample Size Calculator', preview: 'PCAOB AS 2315 sample sizes by frequency and risk rating', href: 'sample-calc.html' },
      { section: 'Page', title: 'Cloud ITGC — AWS, Azure, GCP', preview: 'Cloud-native ITGC controls for the three major platforms', href: 'cloud-itgc.html' },
      { section: 'Page', title: 'Vendor & SOC 1 Review Guide', preview: 'Evaluate SOC 1 reports, test CUECs, document reliance', href: 'vendor-soc1.html' },
      { section: 'Page', title: 'ERP Control Guides', preview: 'SAP, Oracle, NetSuite specific ITGC evidence and testing patterns', href: 'erp-guides.html' },
      { section: 'Page', title: 'Printable Audit Programs', preview: 'Step-by-step test programs for LA, CM, CO, PD, JE', href: 'audit-programs.html' },
      { section: 'Page', title: 'Interview Question Bank', preview: 'SOX IT audit interview prep — flashcards and Q&A by domain', href: 'interview-prep.html' },
      // Key terms
